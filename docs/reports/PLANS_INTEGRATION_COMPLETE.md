...
You can now open a new IDE window with the `$(pwd)` project and have immediate
access to:
...
You can now open `$(pwd)` in a new IDE window and have everything you need to
implement the high-efficiency Docker standards across your projects!
